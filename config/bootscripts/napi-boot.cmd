...
if test "${soc}" = "rk3308"; then setenv serialcon "ttyS0,1500000"; else setenv serialcon "ttyS2,1500000"; fi
if test "${console}" = "serial" || test "${console}" = "both"; then setenv consoleargs "console=${serialcon} ${consoleargs}"; fi

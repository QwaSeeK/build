...
if test "${napi_storage}" = "emmc"; then setenv fdtfile "rockchip/rk3308-napi-c-emmc.dtb"; fi
if test "${napi_storage}" = "sdnand"; then setenv fdtfile "rockchip/rk3308-napi-c-sdnand.dtb"; fi
echo "Onboard storage: ${napi_storage}; device tree: ${fdtfile}"
